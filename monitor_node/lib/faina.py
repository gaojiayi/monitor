...
#        print
    ...
    def print_stats(self,getFileName):
...
def faina_start(fileName,getFileName):
    with open(getFileName,"w") as f:
        f.close()
    counter = StatCounter()
    with open(fileName,"r") as f1:
        counter.process_input(f1.readlines())
    counter.print_stats(getFileName)
